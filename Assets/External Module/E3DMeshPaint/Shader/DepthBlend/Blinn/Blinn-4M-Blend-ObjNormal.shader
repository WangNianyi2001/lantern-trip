...
Shader "E3D/Ground-Blinn/4M-Blend-ObjNormal"
{
	Properties
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_AOMap = IN.ase_texcoord3.xy * _AOMap_ST.xy + _AOMap_ST.zw;
				...
				float3 tanNormal12_g1 = BlendNormal( ( ( ( ( 2.0 * appendResult288 ) + -0.42 ) * _01_CustomExpression_X107 ) + ( ( ( 2.0 * appendResult285 ) + -0.42 ) * _01_CustomExpression_Y108 ) + ( ( -0.42 + ( appendResult289 * 2.0 ) ) * _01_CustomExpression_Z109 ) + ( ( ( appendResult314 * 2.0 ) + -0.42 ) * _01_CustomExpression_W308 ) ) , SAMPLE_TEXTURE2D( _NormalObj, sampler_NormalObj, uv_NormalObj ).rgb );
				...
				float4 Albedo350 = ( ( ( tex2DNode22 * _01_CustomExpression_X107 * _Color_Splat1 ) + ( tex2DNode6 * _01_CustomExpression_Y108 * _Color_Splat2 ) + ( tex2DNode7 * _01_CustomExpression_Z109 * _Color_Splat3 ) + ( tex2DNode305 * _01_CustomExpression_W308 * _Color_Splat4 ) ) * _ColorAll * IN.ase_color );
				float4 temp_cast_4 = (0.1).xxxx;
				#ifdef _NORMALCHECK_ON
				float4 staticSwitch342 = temp_cast_4;
				#else
				float4 staticSwitch342 = Albedo350;
				#endif
				float4 temp_output_42_0_g1 = staticSwitch342;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( SAMPLE_TEXTURE2D( _AOMap, sampler_AOMap, uv_AOMap ) * ( ( float4( (temp_output_43_0_g1).rgb , 0.0 ) * (temp_output_43_0_g1).a * pow( max( dotResult19_g1 , 0.0 ) , ( _Shininess * 128.0 ) ) * temp_output_40_0_g1 ) + ( ( ( temp_output_40_0_g1 * max( dotResult14_g1 , 0.0 ) ) + float4( bakedGI34_g1 , 0.0 ) ) * float4( (temp_output_42_0_g1).rgb , 0.0 ) ) ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18400
-1902;134;1435;620;-1299.021;-1044.502;1.690073;True;False
...
Node;AmplifyShaderEditor.SamplerNode;7;-1869.229,559.3992;Inherit;True;Property;_Splat3;Splat3;9;0;Create;True;0;0;False;0;False;-1;None;2ab0e44223755ca4abe7ac85b6ae6ee6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;22;-1875.166,-21.11561;Inherit;True;Property;_Splat1;Splat1;5;0;Create;True;0;0;False;0;False;-1;None;1e095567961c2c144b69b1bc19858782;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;6;-1865.197,266.7216;Inherit;True;Property;_Splat2;Splat2;7;0;Create;True;0;0;False;0;False;-1;None;bdf2c2b6d0dbe804e8c9a510dd5cffae;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;305;-1875.18,837.5529;Inherit;True;Property;_Splat4;Splat4;11;0;Create;True;0;0;False;0;False;-1;None;d4c73bcb25f70584586408aa207c510c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;144;-1469.912,332.5686;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;-1887.536,1417.109;Inherit;True;Property;_Control;Control;22;0;Create;True;0;0;False;0;False;-1;None;5afa5ddb420888f41ac0a31a66efd6dc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1257.393,1264.321;Float;False;Property;_Weight;Weight;23;0;Create;True;0;0;False;0;False;0.001;0.162;0.001;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;310;-392.1808,1033.462;Float;False;Property;_Color_Splat4;Color_Splat4;12;0;Create;True;0;0;False;0;False;1,1,1,0;0.3463866,0.502314,0.5283019,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;351;3004.04,1529.231;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;350;2195.221,364.6609;Inherit;False;Albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;244;-424.4259,434.9497;Float;False;Property;_Color_Splat2;Color_Splat2;8;0;Create;True;0;0;False;0;False;1,1,1,0;0.6509434,0.6509434,0.6509434,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;245;-415.1362,712.3382;Float;False;Property;_Color_Splat3;Color_Splat3;10;0;Create;True;0;0;False;0;False;1,1,1,0;0.7547169,0.6298254,0.4663581,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;279;1075.212,4098.245;Float;False;Property;_SmoothAll;SmoothAll;13;0;Create;True;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;343;2115.9,1511.468;Inherit;False;350;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;315;-1121.106,3424.828;Inherit;True;Property;_Splat4N;Splat4-N;20;0;Create;True;0;0;False;0;False;-1;None;ad2372964d318e248ae1e8b6b16ed6ed;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;262;-1069.286,2382.551;Inherit;True;Property;_Splat2N;Splat2-N;16;0;Create;True;0;0;False;0;False;-1;None;8238010411ff7d246964954b27ad7001;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;340;1878.89,2534.752;Inherit;False;Property;_NormalScale;NormalScale;25;0;Create;True;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;322;247.5248,5169.158;Float;False;Property;_Smooth4;Smooth4;21;0;Create;True;0;0;False;0;False;1;1.91;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;263;-1087.835,2938.267;Inherit;True;Property;_Splat3N;Splat3-N;18;0;Create;True;0;0;False;0;False;-1;None;c0711bfd5e4274547b7957a47fea6a57;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;344;2136.385,1615.469;Inherit;False;Constant;_Float2;Float 2;28;0;Create;True;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;10;-1106.074,1823.412;Inherit;True;Property;_Splat1N;Splat1-N;14;0;Create;True;0;0;False;0;False;-1;None;351f2d2be2b51524d90b3ca9a80ee03f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;233;239.3187,4249.112;Float;False;Property;_Smooth1;Smooth1;15;0;Create;True;0;0;False;0;False;1;0.45;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;337;2232.295,2486.706;Inherit;True;Property;_NormalObj;NormalObj;24;0;Create;True;0;0;False;0;False;-1;None;efab89247086b3d4a9839d21d19298ec;True;0;True;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;278;235.9401,4854.588;Float;False;Property;_Smooth3;Smooth3;19;0;Create;True;0;0;False;0;False;1;0.3;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;277;250.9404,4533.589;Float;False;Property;_Smooth2;Smooth2;17;0;Create;True;0;0;False;0;False;1;0.37;0;2;0;1;FLOAT;0
...
WireConnection;341;42;342;0
WireConnection;341;52;338;0
WireConnection;341;43;282;0
WireConnection;346;2;351;0
ASEEND*/
//CHKSM=3EC53C4D572B0710C2BF5DA192BEF7D836AE47AA