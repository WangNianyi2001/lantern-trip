	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 appendResult376 = (float2(0.0 , ( _Mask_Offset.y + packedInput.ase_texcoord1.w )));
				float2 texCoord216 = packedInput.ase_texcoord1.xy * _Mask_Scale + appendResult376;
				...
				float clampResult388 = clamp( ( tex2D( _ColorGradientMask, panner320 ).r * _GradientColor_Multi ) , 0.0 , 1.0 );
				float4 lerpResult285 = lerp( _Color_01 , _Color_02 , clampResult388);
		...
		Pass
		{
					...
					)
			{
				...
				float2 panner79 = ( windSpeed200 * _NoiseDistortion_Speed + ( texCoord30 * _NoiseDistortion_Scale ));
				float Distortion64 = ( ( tex2D( _NoiseDistortion_Texture, panner79 ).r * 0.1 ) * _DistortionAmount );
				float2 appendResult376 = (float2(0.0 , ( _Mask_Offset.y + packedInput.ase_texcoord.w )));
				float2 texCoord216 = packedInput.ase_texcoord.xy * _Mask_Scale + appendResult376;
				float4 tex2DNode214 = tex2D( _Mask_Texture, ( ( Distortion64 * _DistortionMaskIntensity ) + texCoord216 ) );
				float temp_output_227_0 = saturate( ( pow( tex2DNode214.r , _Mask_Power ) * _Mask_Multiply ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 panner79 = ( windSpeed200 * _NoiseDistortion_Speed + ( texCoord30 * _NoiseDistortion_Scale ));
				float Distortion64 = ( ( tex2D( _NoiseDistortion_Texture, panner79 ).r * 0.1 ) * _DistortionAmount );
				float2 appendResult376 = (float2(0.0 , ( _Mask_Offset.y + packedInput.ase_texcoord3.w )));
				float2 texCoord216 = packedInput.ase_texcoord3.xy * _Mask_Scale + appendResult376;
				float4 tex2DNode214 = tex2D( _Mask_Texture, ( ( Distortion64 * _DistortionMaskIntensity ) + texCoord216 ) );
				float temp_output_227_0 = saturate( ( pow( tex2DNode214.r , _Mask_Power ) * _Mask_Multiply ) );
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;3185.234;4423.688;1.36182;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;312;275.1099,823.532;Inherit;False;471;185;Particle System Opacity;2;308;309;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;328;-2851.907,-2886.208;Inherit;False;2569.005;1013.434;COLOR;14;388;260;387;329;287;285;386;320;318;319;327;317;316;283;;0,0,0,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;308;325.1098,873.532;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;236;696.733,203.0041;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;387;-1592.227,-2243.909;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;260;-1313.051,-2670.775;Inherit;False;Property;_Color_02;Color_02;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,0.6769685,0.2,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;281;1252.146,661.8631;Inherit;False;280;CameraOffset;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;287;-1271.051,-2852.775;Inherit;False;Property;_Color_01;Color_01;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,0.7019608,0.1019608,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;385;1493.336,31.30363;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;240;464.7323,307.0042;Inherit;False;Property;_EmissiveIntensity;Emissive Intensity;24;0;Create;True;0;0;0;False;0;False;1;30;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;329;-583.8855,-2857.223;Inherit;False;Color;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;388;-1424.949,-2247.463;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;285;-887.0504,-2852.775;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;386;-1923.714,-2013.094;Inherit;False;Property;_GradientColor_Multi;GradientColor_Multi;21;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;309;581.1083,873.532;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;378;1;236;0
WireConnection;378;2;309;0
WireConnection;378;6;281;0
ASEEND*/
//CHKSM=52D200E138121DD39C7C2D5A75B9F11D0DFBBF31