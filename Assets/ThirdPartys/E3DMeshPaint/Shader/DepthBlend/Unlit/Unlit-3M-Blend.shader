...
Shader "E3D/Ground-Unlit/3M-Blend"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( ( tex2DNode22 * _01_CustomExpression_X107 * _Color_Splat1 ) + ( tex2DNode6 * _01_CustomExpression_Y108 * _Color_Splat2 ) + ( tex2DNode7 * _01_CustomExpression_Z109 * _Color_Splat3 ) ) * _ColorAll * IN.ase_color ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18400
-1767;175;1435;626;-1144.168;-294.6872;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;13;-1701.809,1440.918;Inherit;True;Property;_Control;Control;7;0;Create;True;0;0;False;0;False;-1;None;3bdcb93c836741b41aa97a3bd5937f60;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;138;-1400.781,1194.249;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-1112.742,1266.573;Float;False;Property;_Weight;Weight;8;0;Create;True;0;0;False;0;False;0.001;0.063;0.001;1;0;1;FLOAT;0
...
WireConnection;306;2;198;0
ASEEND*/
//CHKSM=E27A4E7E44A1CF8553CCF89FF2AB19700A51B6ED