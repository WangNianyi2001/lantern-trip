...
Shader "E3D/Ground-PBR/3M-Blend-ObjNormal-Channel"
{
	Properties
	{
		...
		_NormalObj1("NormalObj", 2D) = "bump" {}
		_NormalScale1("NormalScale", Range( 0 , 2)) = 1
		_Weight("Weight", Range( 0.001 , 1)) = 0.001
		_Control("Control", 2D) = "white" {}
		_MaskMap("MaskMap", 2D) = "white" {}
		[Toggle(_SHOWCHANNEL_ON)] _ShowChannel("ShowChannel", Float) = 0
		[KeywordEnum(Road,River,PoolSea,Flat,Water_All,MainArea)] _ChannelName("ChannelName", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _SHOWCHANNEL_ON
			#pragma shader_feature_local _CHANNELNAME_ROAD _CHANNELNAME_RIVER _CHANNELNAME_POOLSEA _CHANNELNAME_FLAT _CHANNELNAME_WATER_ALL _CHANNELNAME_MAINAREA
			...
			TEXTURE2D(_NormalObj1);
			SAMPLER(sampler_NormalObj1);
			TEXTURE2D(_MaskMap);
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_NormalObj1 = IN.ase_texcoord7.xy * _NormalObj1_ST.xy + _NormalObj1_ST.zw;
				float3 unpack305 = UnpackNormalScale( SAMPLE_TEXTURE2D( _NormalObj1, sampler_NormalObj1, uv_NormalObj1 ), _NormalScale1 );
				unpack305.z = lerp( 1, unpack305.z, saturate(_NormalScale1) );
				
				float4 temp_cast_2 = (0.0).xxxx;
				float2 uv_MaskMap = IN.ase_texcoord7.xy * _MaskMap_ST.xy + _MaskMap_ST.zw;
				float4 tex2DNode308 = SAMPLE_TEXTURE2D( _MaskMap, sampler_MaskMap, uv_MaskMap );
				#if defined(_CHANNELNAME_ROAD)
				float staticSwitch309 = tex2DNode308.r;
				#elif defined(_CHANNELNAME_RIVER)
				float staticSwitch309 = tex2DNode308.g;
				#elif defined(_CHANNELNAME_POOLSEA)
				float staticSwitch309 = tex2DNode308.b;
				#elif defined(_CHANNELNAME_FLAT)
				float staticSwitch309 = tex2DNode308.a;
				#elif defined(_CHANNELNAME_WATER_ALL)
				float staticSwitch309 = ( tex2DNode308.g + tex2DNode308.b );
				#elif defined(_CHANNELNAME_MAINAREA)
				float staticSwitch309 = ( tex2DNode308.r + tex2DNode308.a );
				#else
				float staticSwitch309 = tex2DNode308.r;
				#endif
				float4 color313 = IsGammaSpace() ? float4(0.5188679,0.5188679,0.5188679,0) : float4(0.2319225,0.2319225,0.2319225,0);
				#ifdef _SHOWCHANNEL_ON
				float4 staticSwitch315 = ( staticSwitch309 * color313 );
				#else
				float4 staticSwitch315 = temp_cast_2;
				#endif
				...
				float3 Normal = BlendNormal( ( ( ( ( 2.0 * appendResult288 ) + -0.42 ) * _01_CustomExpression_X107 ) + ( ( ( 2.0 * appendResult285 ) + -0.42 ) * _01_CustomExpression_Y108 ) + ( ( -0.42 + ( appendResult289 * 2.0 ) ) * _01_CustomExpression_Z109 ) ) , unpack305 );
				float3 Emission = staticSwitch315.rgb;
				float3 Specular = 0.5;
...
/*ASEBEGIN
Version=18400
35;233;1320;683;-509.1156;-683.2044;3.22683;True;False
...
Node;AmplifyShaderEditor.SamplerNode;6;-1724.946,568.1993;Inherit;True;Property;_Splat2;Splat2;3;0;Create;True;0;0;False;0;False;-1;None;2ab0e44223755ca4abe7ac85b6ae6ee6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;22;-1734.915,280.3621;Inherit;True;Property;_Splat1;Splat1;1;0;Create;True;0;0;False;0;False;-1;None;1e095567961c2c144b69b1bc19858782;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;13;-1701.809,1440.918;Inherit;True;Property;_Control;Control;18;0;Create;True;0;0;False;0;False;-1;None;ea5f79107f83d6c42ac770edadc0cc0e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1112.742,1266.573;Float;False;Property;_Weight;Weight;17;0;Create;True;0;0;False;0;False;0.001;0.053;0.001;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;244;-284.1746,736.4275;Float;False;Property;_Color_Splat2;Color_Splat2;4;0;Create;True;0;0;False;0;False;1,1,1,0;0.5754716,0.5415058,0.4098878,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;245;-274.8849,1013.816;Float;False;Property;_Color_Splat3;Color_Splat3;6;0;Create;True;0;0;False;0;False;1,1,1,0;0.5188679,0.5188679,0.5188679,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;243;-265.6072,461.6089;Float;False;Property;_Color_Splat1;Color_Splat1;2;0;Create;True;0;0;False;0;False;1,1,1,0;0.7559863,0.764151,0.7389196,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;277;468.6216,3942.739;Float;False;Property;_Smooth2;Smooth2;12;0;Create;True;0;0;False;0;False;1;0.3;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;278;453.6214,4263.738;Float;False;Property;_Smooth3;Smooth3;14;0;Create;True;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-1066.252,1895.723;Inherit;True;Property;_Splat1N;Splat1-N;9;0;Create;True;0;0;False;0;False;-1;None;351f2d2be2b51524d90b3ca9a80ee03f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;315;3219.999,1768.798;Inherit;False;Property;_ShowChannel;ShowChannel;20;0;Create;True;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;310;2559.937,1655.731;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;307;1514.385,2644.927;Inherit;False;Property;_NormalScale1;NormalScale;16;0;Create;True;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;309;2729.667,1549.48;Inherit;False;Property;_ChannelName;ChannelName;21;0;Create;True;0;0;False;0;False;0;0;0;True;;KeywordEnum;6;Road;River;PoolSea;Flat;Water_All;MainArea;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;316;3046.999,1767.798;Inherit;False;Constant;_Float1;Float 1;22;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;311;2559.782,1750.731;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;233;457,3658.263;Float;False;Property;_Smooth1;Smooth1;10;0;Create;True;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;263;-1058.321,2998.436;Inherit;True;Property;_Splat3N;Splat3-N;13;0;Create;True;0;0;False;0;False;-1;None;6057c198921498f4b9cc3fe18cb828f4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;232;2670.16,1976.68;Float;False;Property;_Metallic;Metallic;8;0;Create;True;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;313;2722.105,1791.888;Inherit;False;Constant;_InfoColor;InfoColor;21;0;Create;True;0;0;False;0;False;0.5188679,0.5188679,0.5188679,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;305;1867.79,2596.881;Inherit;True;Property;_NormalObj1;NormalObj;15;0;Create;True;0;0;False;0;False;-1;None;4bc2e0ce533bb214abe4114a8bdf4c27;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;308;2193.177,1520.893;Inherit;True;Property;_MaskMap;MaskMap;19;0;Create;True;0;0;False;0;False;-1;None;f49ff9ced835e124fb9c13eb0417a3c1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;312;3044.105,1632.888;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;298;3597.24,1725.217;Float;False;True;-1;2;ASEMaterialInspector;0;2;E3D/Ground-PBR/3M-Blend-ObjNormal-Channel;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;35;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;True;0
...
WireConnection;310;0;308;2
WireConnection;310;1;308;3
WireConnection;286;0;263;0
WireConnection;309;1;308;1
WireConnection;309;0;308;2
WireConnection;309;2;308;3
WireConnection;309;3;308;4
WireConnection;309;4;310;0
WireConnection;309;5;311;0
...
WireConnection;311;0;308;1
WireConnection;311;1;308;4
...
WireConnection;298;2;315;0
WireConnection;298;3;232;0
WireConnection;298;4;282;0
ASEEND*/
//CHKSM=ADE8DA040F72080281C11A697DF02B8F97328DE5