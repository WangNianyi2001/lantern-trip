...
public class HideGroup : MonoBehaviour {
	...
	public bool hideable = true; //if set to false, objects will not hide themself from camera
	...
	private HideablePart[] hideableGroup; //array to store hidable geo children of this object
    ...
    void Start()
		{	
			...
			hideableGroup = gameObject.GetComponentsInChildren<HideablePart>();	
		...
		{	
			...
			if (other.gameObject.tag == "MainCamera")
				{	
					...
					foreach (HideablePart part in hideableGroup)
					part.hide();
